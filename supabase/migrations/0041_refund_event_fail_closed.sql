-- 0041_refund_event_fail_closed.sql — Codex Round 12 P1-3.
...
DECLARE v_req record; v_alloc record; v_all boolean; v_terminal boolean; v_case uuid; v_status text;
BEGIN
  ...
  END IF;
  IF v_req.id IS NULL THEN RETURN jsonb_build_object('outcome','unmatched'); END IF;
