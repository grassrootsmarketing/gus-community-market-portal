...
-- with 0073 still hidden, the ledger tail must be EXACTLY the planned production sequence (0074..0083) — every
-- version named, none missing, 0073 never inserted. This is the record the cutover runbook copies.
DO $$
DECLARE v_tail text; v_expected text := '0074,0075,0076,0077,0078,0079,0080,0081,0082,0083';
BEGIN
