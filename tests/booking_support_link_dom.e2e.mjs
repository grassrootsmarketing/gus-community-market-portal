...
try {
  for (const [label, viewport] of [['desktop', { width: 1280, height: 900 }], ['phone', { width: 375, height: 812 }]]) {
    ...
    const form = await page.evaluate(() => { const l = document.getElementById('bookSupportLink'); return { href: l.getAttribute('href'), inForm: !!l.closest('#contactInfoModal'), afterError: !!(document.getElementById('bookErrorMsg').compareDocumentPosition(l) & 4 /* DOCUMENT_POSITION_FOLLOWING */) }; });
